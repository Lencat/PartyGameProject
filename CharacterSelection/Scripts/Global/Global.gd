...
const ARTIST_SCENE = preload("res://2DCharacters/Scenes/Artist.tscn")
const ASTROLOGER_SCENE = preload("res://2DCharacters/Scenes/Astrologer.tscn")
const CITIZEN_SCENE = preload("res://2DCharacters/Scenes/Citizen.tscn")
