...
public static partial class BoardMovement
{
	//private:
		...
		static TilePath? calculatePaths(ref BoardGameState game, Point2D position, int distance, bool reverse = false, int depth = 0)
		{
			//get current tile
	...
	//public
		public static void move(ref BoardGameState game, ref PlayerCharacter pc, int diceCount = 1, int tempMoveMod = 0, bool reverse = false)
		{
