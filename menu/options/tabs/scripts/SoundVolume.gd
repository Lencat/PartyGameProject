...
@onready var audio_name_lbl = $HBoxContainer/Label as Label
@onready var audio_num_lbl = $HBoxContainer/Number as Label
@onready var h_slider = $HBoxContainer/HSlider as HSlider

@export_enum("Master", "Music", "Sound") var bus_name : String
