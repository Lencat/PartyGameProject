...
func update_display():
	...
	#characterNameLabel.text = ["Artist", "Astrologer", "Citizen", "Sage", "Warlord"][character_index]
	playerSelectNode.play(["artist", "astrologer", "citizen", "sage", "warlord"][character_index])
...
func _on_left_pressed():
	...
	current_selection = (current_selection - 1 + 5) % 5
...
func _on_main_menu_pressed():
	var main_menu = load("res://menu/main/menu_main.tscn")
